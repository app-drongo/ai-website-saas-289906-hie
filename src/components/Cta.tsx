...
export default function Cta() {
  const stats = [
    { value: "2000+", label: "Enterprise Clients", icon: Users },
    { value: "99.99%", label: "Data Accuracy", icon: Shield },
    { value: "500+", label: "Data Connectors", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join industry leaders who trust DataFlow Analytics to drive data-driven decisions. 
                Start your transformation with real-time insights and advanced visualization tools.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by Fortune 500 companies and data-driven organizations worldwide
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">30-Day Free Trial</h3>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SOC 2 compliant with 99.99% uptime guarantee
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Go live in days with our expert implementation team
              </p>
            </div>
          </div>
        </div>
