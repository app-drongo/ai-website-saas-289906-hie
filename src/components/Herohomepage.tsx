...
import { ArrowRight, Play, Star, Users, TrendingUp, Database } from "lucide-react"
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
              ...
              New: Real-Time AI Analytics Engine
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Enterprise-grade business intelligence platform that turns complex data into actionable insights. 
              Make data-driven decisions with real-time visualization and advanced analytics.
            </p>
